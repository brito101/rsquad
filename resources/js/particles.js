        ...
        a && Object.deepExtend(i, a),
            ...
            (i.fn.particle = function (e, a, t) {
                ...
                if ("object" == typeof r) {
                    if (r instanceof Array) {
                        this.shape = r[Math.floor(Math.random() * r.length)];
                    }
                } else this.shape = r;
                if ("image" === this.shape) {
                ...
                switch (
                    ...
                    case "polygon":
                        i.fn.vendors.drawShape(
                            i.canvas.ctx,
                            a.x -
                                t / (i.particles.shape.polygon.nb_sides / 3.5),
                            a.y - t / 0.76,
                            (2.66 * t) /
                ...
                i.canvas.ctx.closePath(),
                    i.particles.shape.stroke.width > 0 &&
                        ...
                        (i.canvas.ctx.lineWidth =
                            i.particles.shape.stroke.width),
                        i.canvas.ctx.stroke()),
                    i.canvas.ctx.fill();
            }),
            ...
            (i.fn.modes.bubbleParticle = function (e) {
                ...
                if (
                    ...
                    s = e.x - i.interactivity.mouse.pos_x;
                    n = e.y - i.interactivity.mouse.pos_y;
                    r = Math.sqrt(s * s + n * n);
                    let c = 1 - r / i.interactivity.modes.bubble.distance;
            ...
            (i.fn.modes.repulseParticle = function (e) {
                let p = i.interactivity.mouse.click_pos_x - e.x;
                let d = i.interactivity.mouse.click_pos_y - e.y;
                let c;
                let u;
                function a() {
                ...
                if (
                    ...
                    let t = e.x - i.interactivity.mouse.pos_x,
            ...
            (i.fn.vendors.destroypJS = function () {
                cancelAnimationFrame(i.fn.drawAnimFrame), t.remove();
            }),
            ...
            (i.fn.vendors.checkBeforeDraw = function () {
                "image" === i.particles.shape.type
                    ? "svg" === i.tmp.img_type && void 0 === i.tmp.source_svg
                        ? (i.tmp.checkAnimFrame = requestAnimFrame())
            ...
            (i.fn.vendors.start = function () {
                isInArray("image", i.particles.shape.type)
                    ? ((i.tmp.img_type = i.particles.shape.image.src.substring(
