...
@section('title', '- Edição de Categoria de Cursos')
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST"
                            action="{{ route('admin.course-categories.update', ['course_category' => $category->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                @if ($category->cover)
                                    <div class='col-12 align-self-center mt-3 d-flex justify-content-center px-0'>
                                        <img src="{{ url('storage/course-categories/' . $category->cover) }}"
