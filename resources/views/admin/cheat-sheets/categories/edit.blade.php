...
@section('title', '- Edição de Categoria do Cheat Sheet')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.cheat-sheets-categories.index') }}">Categorias do
                        Cheat Sheet</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST"
                            action="{{ route('admin.cheat-sheets-categories.update', ['cheat_sheets_category' => $category->id]) }}">
                            @csrf
                            @method('PUT')
