...
@section('title', '- Edição de Cheat Sheet')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-th-list"></i> Editar Cheat Sheet</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.cheat-sheets.index') }}">Cheat Sheets</a></li>
                        <li class="breadcrumb-item active">Editar Cheat</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST"
                            action="{{ route('admin.cheat-sheets.update', ['cheat_sheet' => $cheat->id]) }}"
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 form-group px-0">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                            ...
                                            value="{{ old('title') ?? $cheat->title }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="status" required id="status">
                                            <option
                                                {{ old('status') == 'Postado' ? 'selected' : ($cheat->status == 'Postado' ? 'selected' : '') }}
                                                value="Postado">Postado
                                            </option>
                                            <option
                                                {{ old('status') == 'Rascunho' ? 'selected' : ($cheat->status == 'Rascunho' ? 'selected' : '') }}
                                                value="Rascunho">Rascunho
                                            </option>
                                            <option
                                                {{ old('status') == 'Lixo' ? 'selected' : ($cheat->status == 'Lixo' ? 'selected' : '') }}
                                                value="Lixo">Lixo
                                            </option>
                                        </x-adminlte-select2>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="cheat_sheet_category_id" required
                                            ...
                                            @foreach ($categories as $category)
                                                <option
                                                    {{ old('cheat_sheet_category_id') == $category->id ? 'selected' : ($cheat->cheat_sheet_category_id == $category->id ? 'selected' : '') }}
                                                    value="{{ $category->id }}">
                                                    {{ $category->title }}
                                                </option>
                                            @endforeach
