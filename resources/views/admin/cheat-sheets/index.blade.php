...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-th-list"></i> Cheat Sheet</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Cheat Sheets</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Cheats Cadastrados</h3>
                                @can('Criar Cheat Sheet')
                                    <a href="{{ route('admin.cheat-sheets.create') }}" title="Novo Cheat"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Novo Cheat</a>
                                @endcan
                            </div>
                        </div>
